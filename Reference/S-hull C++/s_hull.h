...
struct Shx
{
    ...
    Shx() {};
    Shx(float a, float b) : r(a), c(b), ro(0), id(-1) {};
    Shx(float a, float b, float x) : r(a), c(b), ro(x), id(-1) {};
...
void T_flip2( std::vector<Shx> &pts, std::vector<Triad> &triads, long *slump, long numt, long start);
void T_flip3( std::vector<Shx> &pts, std::vector<Triad> &triads, long *slump, long numt, long start,std::set<long> &ids );
void T_flip4( std::vector<Shx> &pts, std::vector<Triad> &triads, long *slump, std::set<long> &ids);
